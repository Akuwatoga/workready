...
> 面向学生、实习生、应届生和职场新人的 AI 职场 Skill Stack：把入职、计划、协作、汇报、会议、任务管理和团队沟通，变成可以直接调用的 `/` 场景技能。
...
WorkReady 的目标是把这些模糊场景变成可执行的工作流程。用户输入原始信息，AI 按对应 skill 输出可以直接使用的计划、表格、消息、汇报或复盘。
